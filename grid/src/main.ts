...
const inputRangeCol: HTMLInputElement = document.getElementById("nbcol")! as HTMLInputElement
const inputRangeLigne: HTMLInputElement = document.getElementById("nbl")! as HTMLInputElement
...
replaceCells(parseInt(inputRangeCol.value) * parseInt(inputRangeLigne.value), grid)
setNbColCss(rootStyleElem, parseInt(inputRangeCol.value))
setNbRowCss(rootStyleElem, parseInt(inputRangeLigne.value))


inputRangeCol.addEventListener("mousemove", () => {
    afficherValueCol.innerText = inputRangeCol.value
    setNbColCss(rootStyleElem, parseInt(inputRangeCol.value))
    replaceCells(parseInt(inputRangeCol.value) * parseInt(inputRangeLigne.value), grid)
})

inputRangeLigne.addEventListener("mousemove", () => {
    afficherValueLigne.innerText = inputRangeLigne.value
    setNbRowCss(rootStyleElem, parseInt(inputRangeLigne.value))
    replaceCells(parseInt(inputRangeCol.value) * parseInt(inputRangeLigne.value), grid)
})
